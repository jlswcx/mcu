...
void DS_Rest(void) {
    ...
    while(flag) {
        TRISC4 = RC4 = 0;
        _delay((unsigned long)((480)*(4000000/4000000.0)));
        TRISC4 = 1;
    ...
    GIE = 1;
    _delay((unsigned long)((240)*(4000000/4000000.0)));
}
