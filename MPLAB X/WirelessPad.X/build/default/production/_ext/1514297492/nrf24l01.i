...
unsigned char NRF_Read_Buf(unsigned char reg, unsigned char *pBuf, unsigned char buf);
unsigned char NRF_Write_Buf(unsigned char reg, unsigned char *pBuf, unsigned char buf);
...
unsigned char NRF_IRQ_Reset(void);
