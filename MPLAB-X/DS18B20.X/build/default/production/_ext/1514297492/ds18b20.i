...
# 2 "<built-in>" 2
# 1 "../library/ds18b20.c" 2
# 1 "../library/ds18b20.h" 1
# 30 "../library/ds18b20.h"
void DS_Rest();
...
# 15 "../library/header.h" 2

# 1 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\include\\eeprom_routines.h" 1 3
# 114 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\include\\eeprom_routines.h" 3
extern void eeprom_write(unsigned char addr, unsigned char value);
extern unsigned char eeprom_read(unsigned char addr);
# 16 "../library/header.h" 2
...
void DS_Rest() {
    ...
    while(flag) {
        TRISA2 = 0;
        RA2 = 0;
        _delay((unsigned long)((800)*(125000/4000000.0)));
        TRISA2 = 1;
        _delay((unsigned long)((80)*(125000/4000000.0)));
        if(!RA2) {
            flag = 0;
        }
...
void DS_Write(char command) {
    for(signed char i = 8; i > 0; i--) {
        ...
        TRISA2 = command & 0x01;
        _delay((unsigned long)((60)*(125000/4000000.0)));
        TRISA2 = 1;
        _delay((unsigned long)((5)*(125000/4000000.0)));
        command >>= 1;
    }
...
char DS_Read() {
    ...
    for(signed char i = 8; i > 0; i--) {
        ...
        _delay((unsigned long)((5)*(125000/4000000.0)));
        TRISA2 = 1;
        _delay((unsigned long)((20)*(125000/4000000.0)));
        temp = RA2;
