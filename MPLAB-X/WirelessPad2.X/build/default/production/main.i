...
unsigned char const pad_aux_off[2] = {0x03,0x03};

unsigned char pad_aux_dat[2] = {0x00, 0x00};

unsigned char PAD_MODE = 0;

unsigned char tx_addr[5] = {0x0F, 0x0E, 0x0D, 0x0C, 0x0B};

unsigned char rx_addr_0[5] = {0x0F, 0x0E, 0x0D, 0x0C, 0x0B};
unsigned char rx_addr_1[5] = {0x66, 0x8E, 0x29, 0xF3, 0xA5};
unsigned char rx_addr_2[5] = {0x99, 0x8E, 0x29, 0xF3, 0xA5};
unsigned char rx_addr_3[5] = {0x33, 0x8E, 0x29, 0xF3, 0xA5};
unsigned char rx_addr_4[5] = {0x88, 0x8E, 0x29, 0xF3, 0xA5};
unsigned char rx_addr_5[5] = {0x55, 0x8E, 0x29, 0xF3, 0xA5};
...
void WirelessPad() {
    ...
    while(1) {
        ...
        if(adc == 1) {
            ...
            ADON = 1;
            _delay((unsigned long)((2)*(125000/4000.0)));
